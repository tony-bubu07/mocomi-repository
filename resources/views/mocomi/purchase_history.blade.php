...
<head>
    ...
    <title>Mocomi | 購入履歴</title>

    <!-- css読み込みタグ -->
    <!-- parts (ヘッダー、フッター) -->
    <link rel="stylesheet" href="{{asset('css/parts.css')}}">
    <!-- 各ページに合わせて変える -->
    <link rel="stylesheet" href="{{asset('css/purchase_histry.css')}}">
...
<body>
    ...
    <main>
        <h1 class="purchase_histry_title">購入履歴</h1>
        <div class="purchase_histry_wrap">
            <div class="purchase_histry_item_box">
                ...
                <a href="{{ route('comic_browse') }}" class="readWrap">
