...
<head>
    ...
    <title>Mocomi | アカウント削除完了</title>

    <!-- css読み込みタグ -->
    <!-- parts (ヘッダー、フッター) -->
    <link rel="stylesheet" href="{{asset('css/parts.css')}}">
    <!-- 各ページに合わせて変える -->
    <link rel="stylesheet" href="{{asset('css/account_delete_complete.css')}}">
...
<body>
    ...
    <main>
        ...
        <div class="complete_wrap">
            <div class="title">
                <h1 class="title_text">アカウント情報 削除完了</h1>
            </div>
            <div class="message">
                <p class="message_text">削除が完了いたしました</p>
                <p class="message_text2">ご利用いただき誠にありがとうございました</p>
            </div>
            <div class="button">
